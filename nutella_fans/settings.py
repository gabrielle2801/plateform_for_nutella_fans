"""
Django settings for nutella_fans project.
...
SECRET_KEY = 'django-insecure-0=(^5osj0bs(@nawz5u)pw+9^y)u-z8k(!*t_q#r5t=%f1zj4$'
...
WSGI_APPLICATION = 'nutella_fans.wsgi.application'
...
DEFAULT_AUTO_FIELD = 'django.db.models.BigAutoField'
AUTH_USER_MODEL = 'users_account.User'
